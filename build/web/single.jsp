	...
	<div class="ads-grid_shop">
		<div class="shop_inner_inf">
			<div class="col-md-4 single-right-left ">
				<div class="grid images_3_of_2">
					<div class="flexslider">
						...
						<ul class="slides">
							<li data-thumb="${requestScope.productDetails.productImg}">
								<div class="thumb-image"> <img src="${requestScope.productDetails.productImg}" data-imagezoom="true" class="img-responsive"> </div>
							</li>
			...
			<div class="col-md-8 single-right-left simpleCart_shelfItem">
                            <h3>${requestScope.productDetails.productName}</h3>
				<p><span class="item_price">$${requestScope.productDetails.productPrice}</span>
					<del>$1,199</del>
				</p>
				<div class="rating1">
					<ul class="stars">
				...
				<div class="color-quality">
					<div class="color-quality-right">
                                            <h5><b>Quantity :</b></h5>
                                            <p>${requestScope.productDetails.productQuantity}</p>
					</div>
				</div>
                                <div class="color-quality">
					<div class="color-quality-right">
                                            <h5><b>Category :</b></h5>
                                            <p>${requestScope.productDetails.productCategory}</p>
					</div>
				</div>
                                <div class="color-quality">
					<div class="color-quality-right">
                                            <h5><b>Color :</b></h5>
                                            <p>${requestScope.productDetails.productColor}</p>
					</div>
				</div>
					...
					<div class="resp-tabs-container">
						...
						<div class="tab1">
							...
							<div class="single_page">
								...
								<p>${requestScope.productDetails.productDesc}</p>
							</div>
						</div>
						<!--//tab_one-->
						<div class="tab2">
						...
						<div class="tab3">
							...
							<div class="single_page">
								<h6>${requestScope.productDetails.productName}</h6>

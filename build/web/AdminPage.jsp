...
<c:if test="${sessionScope.userInfo.state == 'u'}">

    <jsp:forward page="index.jsp"></jsp:forward>
                                                
</c:if>

<c:if test="${empty sessionScope.userInfo.state}">
	...
	<div class="ads-grid_shop">
            ...
            <div style="text-align: center">
                ...
                <form action="allProducts" method="POST">
                    <input type="submit" value="Manage All Products"/>
                </form>
                    <!--lazzzzzzzzzzzzem t3ml al id hna bl session ??????????? --> 
                <form action="allUsers" method="POST">
                    <input type="hidden" name="id" value="${sessionScope.userInfo.id}"/>
                    <input type="submit" value="Manage All Users"/>
                </form>

    ...
    <body>
        ...
        <div class="ads-grid_shop">
            ...
            <div style="text-align: center">
                ...
                <div class="left-ads-display col-md-8 col-md-offset-2">
                                    ...
                                    <div class="product-shoe-info shoe">
                                        <div class="men-pro-item">
                                            <div class="men-thumb-item">
                                                <img src="${sessionScope.productsInfoAdmin[i].productImg}" alt="product Img">
                                                <div class="men-cart-pro">
                                                    <div class="inner-men-cart-pro">
                                                        <a href="displaySingleProduct?productId=${sessionScope.productsInfoAdmin[i].id}" class="link-product-add-cart">${sessionScope.productsInfoAdmin[i].id}</a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="item-info-product">
                                                ...
                                                <h4>
                                                    <a href="displaySingleProduct?productId=${sessionScope.productsInfoAdmin[i].id}">${sessionScope.productsInfoAdmin[i].productName} </a>
                                                </h4>

...
<c:if test="${empty allProductsSearch[0].productName}">
				...
				<div class="wrapper_top_shop">
					...
					<div class="product-sec1">
						<!--/mens-->
                                                ...
                                                <c:forEach var="i" begin="0" end="${allProductsSearch.size()-1}">
							...
							<div class="product-shoe-info shoe">
								<div class="men-pro-item">
									...
									<div class="item-info-product">
										<h4>
											<a href="single.jsp">${allProductsSearch[i].productName} </a>
										</h4>
										<div class="info-product-price">
											...
											<div class="shoe single-item hvr-outline-out">
												<form action="#" method="post">
													<input type="hidden" name="cmd" value="_cart">
                                                                                                        <input type="hidden" name="id" value="${allProductsSearch[i].id}">
													<input type="hidden" name="add" value="1">
													<input type="hidden" name="shoe_item" value="${allProductsSearch[i].productName}">
                                                                                                        <input type="hidden" name="amount" value="${allProductsSearch[i].productPrice}">
                                                                                                        <button type="button" class="shoe-cart pshoe-cart" onclick="Add(${allProductsSearch[i].id});"><i class="fa fa-cart-plus" aria-hidden="true"></i></button>

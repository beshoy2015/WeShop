				...
				<div class="col-md-7 contact_grid_right">
				  ...
				  <form action="UpdateUser" method="post">
						<div class="col-md-6 col-sm-6 contact_left_grid">
                                                    ...
                                                    <input type="text" name="userName" placeholder="productName" required="" value="${userName}">
                                                        ...
                                                        <input type="text" name="mobile" placeholder="mobile" required="" value="${mobile}">
                                                        <br><br>
                                                        <input type="text" name="money" placeholder="money" required="" value="${money}">
                                                        <input type="text" name="img" placeholder="img" required="" value="${img}">
                                                        <input type="text" name="creditCard" placeholder="creditCard" required="" value="${creditCard}">

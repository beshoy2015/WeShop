				  ...
				  <form action="AddUser" method="post">
						<div class="col-md-6 col-sm-6 contact_left_grid">
                                                    ...
                                                    <input type="text" name="userName" placeholder="username" required="" >
                                                        ...
                                                        <input type="text" name="creditCard" placeholder="creditCard" required="" >
                                                        <input type="radio" name="userState" value="u">User <br>
                                                        <input type="radio" name="userState" value="a">Admin <br>
